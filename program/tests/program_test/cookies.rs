...
impl SpotMarketCookie {
    ...
    pub async fn edit_order(
        ...
        println!("editing: {} ", client_order_id);
        let order = serum_dex::instruction::NewOrderInstructionV3 {
            side: side, //serum_dex::matching::Side::Bid,
            limit_price: NonZeroU64::new(limit_price).unwrap(),
            max_coin_qty: NonZeroU64::new(max_coin_qty).unwrap(),
        ...
        test.edit_spot_order(&mango_group_cookie, self, user_index, order).await;
    ...
    pub async fn edit_order2(
        ...
        test.edit_spot_order2(&mango_group_cookie, self, user_index, cancel_order, new_order).await;
